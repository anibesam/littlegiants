          ...
          <div className="pt-32 pb-20 md:pt-40 md:pb-44">
            ...
            <div className="max-w-xl mx-auto md:max-w-none md:flex md:items-center md:space-x-8 lg:space-x-16 xl:space-x-20 space-y-16 md:space-y-0">
              ...
              <div className="text-center md:text-left md:min-w-[30rem]" data-aos="fade-right">
                <h1 className="h1 font-playfair-display text-white mb-4">Little Giants Foundation</h1>
                <p className="text-xl text-gray-100 mb-8">So whether you are a hero in your own right, or simply want to support those who are making a difference, we invite you to join us on this journey. Together, we can create a brighter future for all of our children. Thank you for your support.</p>
                <div className="max-w-xs mx-auto sm:max-w-none sm:flex sm:justify-center md:justify-start space-y-4 sm:space-y-0 sm:space-x-4">
                  <div>
                    <Link className="btn text-white bg-orange-500 hover:bg-slate-800 w-full" to="#0">Learn More</Link>
                  </div>
                </div>
              </div>
              ...
              <div data-aos="fade-left">
                ...
                <div className="flex justify-center items-center">
                  ...
                  <img className="mx-auto md:max-w-none" src="https://cdn.pixabay.com/photo/2013/01/30/15/28/family-76782_960_720.jpg" width="540" height="405" alt="Hero" />
                  </div>
